...
\begin{abstract}This is my summary of the French monograph by Chambert-Loir--Ducros, which in particular develops a local theory of pluripotential functions on analytic spaces. All errors are mine and any corrections are welcome. 
\end{abstract}
...
\subsubsection*{5.9: Boundary measure.} This section concerns $(n-1,n)$-type forms $\omega$. FOr any closed skeletal subset $\Sigma$ that strongly supports $\omega$, the restriction $\omega|_{\Sigma^{(n)}}$ is an $(n-1)$-vector volume on $X$ and is independent of choice of $\Sigma$. 
...
\subsubsection*{6.2: Smooth forms on affine $G$-tropical spaces. }
